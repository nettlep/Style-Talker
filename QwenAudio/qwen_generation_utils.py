'''
Copied from Qwen-Audio
https://github.com/QwenLM/Qwen-Audio/blob/main/qwen_generation_utils.py
'''
    ...
    if chat_format == "chatml":
        ...
        def _tokenize_str(role, content):
            ...
            return f"{role}\n{content}", tokenizer.encode(
                role, allowed_special=set(list(tokenizer.AUDIO_ST)+tokenizer.additional_special_tokens), 
                audio_info=audio_info
            ) + nl_tokens + tokenizer.encode(content, allowed_special=set(
                list(tokenizer.AUDIO_ST)+tokenizer.additional_special_tokens
